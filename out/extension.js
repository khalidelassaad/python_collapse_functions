...
function activate(context) {
    const command = vscode.commands.registerCommand('python-collapse-functions.collapseAll', async () => {
        ...
        if (selections.length > 0) {
            editor.selection = new vscode.Selection(selections[0].start, selections[0].start);
        }
    });
